                ...
                <div className="card asignatura-section " name={this.props.cuestionario.title} id={this.props.idCuestionario}>
                    ...
                    <div className='asignatura-inner-body row'>
                       ...
                       <div className="col-3 button-section">
                            ...
                            {(this.state.downloaded && !this.state.corregido && this.state.bloqueado && localStorage.getItem("rol") == "student") && <button type="button" className="btn btn-primary" data-bs-toggle="modal" onClick={this.show_modal}>Realizar</button>}
